        ...
        <footer className='bg-[#1E272E] pt-5 py-9 lg:pt-10'>
            <div className="container">
                <div className="flex flex-col lg:grid lg:grid-cols-4 gap-y-11">
                    <Link href="/">
                        <ImageItem src='/images/logo.png' alt='logo' className='w-[190px]' />
                    </Link>

                    {footerMenu.map((ftMenu, i) => (
                        <div key={i}>
                            <p className="text-zinc-300 text-xl font-semibold">{ftMenu.label}</p>
                    ...
                    <div>
                        ...
                        <div className="flex gap-x-4 mt-4">
                            {socmed.map((soc, i) => (
                                <Link key={i} href={soc.link} className='bg-background w-[26px] h-[26px] rounded-full flex place-content-center items-center'>
                ...
                <p className='text-sm text-center text-stone-200'>© Copyright 2023, All Rights Reserved by DevDesign Team 3</p>
            </div>
        </footer>
    )
}
